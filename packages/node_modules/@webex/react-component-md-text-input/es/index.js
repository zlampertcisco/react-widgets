...
class MDTextInput extends AdaptiveCard.TextInput {
  ...
  internalRender() {
    this.value = this.defaultValue || ''; // Input style of Adaptive card supports Text, email, phone and url
    ...
    const jsx = /*#__PURE__*/React.createElement(Input, {
      label: this.title,
      value: this.value,
      ...
      className: classnames('ac-input', 'ac-textInput', {
        'ac-multiline': !!this.isMultiline
      }),
      onChange: event => {
